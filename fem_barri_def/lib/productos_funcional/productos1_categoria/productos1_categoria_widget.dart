...
import 'productos1_categoria_model.dart';
export 'productos1_categoria_model.dart';

class Productos1CategoriaWidget extends StatefulWidget {
  const Productos1CategoriaWidget({
    Key? key,
  ...
  @override
  _Productos1CategoriaWidgetState createState() =>
      _Productos1CategoriaWidgetState();
}

class _Productos1CategoriaWidgetState extends State<Productos1CategoriaWidget> {
  late Productos1CategoriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Productos1CategoriaModel());
  }
