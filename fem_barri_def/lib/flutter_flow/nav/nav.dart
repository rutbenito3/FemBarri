      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : NavBarPage(
                  initialPage: 'MainPrincipal',
                  page: MainPrincipalWidget(),
                ),
        ),
        FFRoute(
          name: 'Perfil',
        ...
        FFRoute(
          ...
          path: '/afegirProducte',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AfegirProducte')
              : NavBarPage(
                  initialPage: 'AfegirProducte',
                  page: AfegirProducteWidget(),
                ),
        ),
        FFRoute(
          name: 'PruebaBarris',
          path: '/pruebaBarris',
          builder: (context, params) => PruebaBarrisWidget(),
        ),
        FFRoute(
          name: 'AfegirRessenya',
          path: '/afegirRessenya',
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: AportacionsWidget(),
          ),
        ),
        FFRoute(
          name: 'DetallsProductes',
          path: '/detallsProductes',
        ...
        FFRoute(
          name: 'Productos1Categoria',
          path: '/productos1Categoria',
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: Productos1CategoriaWidget(
              categories: params.getParam('categories', ParamType.String),
            ),
          ),
        ),
        FFRoute(
