...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6B1168);
  late Color secondary = const Color(0xFFE4BCF0);
  late Color tertiary = const Color(0xFFE4BCF0);
  ...
  late Color accent3 = const Color(0xFFE9D8EE);
